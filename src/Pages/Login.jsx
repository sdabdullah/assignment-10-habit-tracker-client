            ...
            <div className='flex justify-center items-center px-10 py-15'>
                ...
                <div className="card bg-[#ffffff] w-full max-w-md border shadow-sm border-[#e5e7eb] pt-6">
                    ...
                    <div className="card-body">
                        <form onSubmit={getLoginInUser}>
                            <fieldset className="fieldset">

                                <div>
                                    <label className="label text-sm font-semibold">Email</label>
                                    <input type="email" className="input w-full border-[#e5e7eb] mt-2 placeholder:text-gray-800 text-black" name='email' placeholder="your@email.com" />
                                </div>

                                <div className='relative'>
                                    <label className="label text-sm font-semibold">Password</label>
                                    <input type={showPassIcon ? "text" : "password"} className="input w-full border-[#e5e7eb] mt-2 placeholder:text-gray-800 text-black" name='password' placeholder="Password" />
                        ...
                        <button onClick={handlegoogleLogin} className="btn rounded bg-white border-gray-300">
